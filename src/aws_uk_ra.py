#!/usr/bin/env python3
"""
AWS UK Resource Agent
Uses configuration from Config_ras/Aws_UK_RA_config.yaml and Aws_UK_RA_capacity.yaml
"""
import sys
import signal
...
def signal_handler(signum, frame):
    ...
    print(f"\nReceived signal {signum}. Shutting down AWS UK RA...")
    if 'ra' in globals():
        ra.stop()
    sys.exit(0)
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"Error starting AWS UK RA: {e}")
        sys.exit(1)
